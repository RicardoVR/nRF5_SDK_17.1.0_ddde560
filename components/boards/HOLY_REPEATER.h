#ifndef HOLYIOT_REPEATER_H
#define HOLYIOT_REPEATER_H
...
// LEDs (P0.21, P0.18, P0.17)
#define LEDS_NUMBER        3
#define LED_START          LED_1  //17
...
#define BUTTON_1           NRF_GPIO_PIN_MAP(0,27)
...
//#define RX_PIN_NUMBER  25 /// P8
//#define TX_PIN_NUMBER  24 //6
//#define CTS_PIN_NUMBER 7
//#define RTS_PIN_NUMBER 5
#define HWFC           true
...
// SWD (solo para referencia; no hace falta usar BSP)
#define SWDCLK_PIN       NRF_GPIO_PIN_MAP(0,26)
#define SWDIO_PIN        NRF_GPIO_PIN_MAP(0,27)
